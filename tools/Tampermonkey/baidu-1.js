// ==UserScript==
// @name         百度网盘直链下载插件2018年4月5日临时版
// @version      2018.04.05
// @description # 分享链接页显示[直链下载]按钮，支持获取直链下载链接，IDM可以高速下载；
// @description # 大文件/单个文件/多个文件/目录 直接下载免调用百度网盘客户端；
// @author       ivesjay、DieMoe、zd423、网友们
// @license       MIT
// @date           2099-01-01
// @modified    2018-04-05
...
(function() {
    ...
    function PanHelper(){
        ...
        function addButton(){
            ...
            var $dropdownbutton_a = $('<a class="g-button" href="javascript:void(0);"><span class="g-button-right"><span class="text" style="width: auto;">直链下载</span></span></a>');
            ...
            var $directbutton_a = $('<a class="g-button" href="javascript:void(0);"><span class="g-button-right"><span class="text" style="width:auto">直链下载</span></span></a>');
            var $directbutton_menu = $('<span class="menu" style="width:120px;left:79px"></span>');
            var $directbutton_download_button = $('<a id="download-direct" class="g-button-menu" href="javascript:void(0);">点击直链下载</a>');
            var $directbutton_link_button = $('<a id="link-direct" class="g-button-menu" href="javascript:void(0);">获取下载链接</a>');
            $directbutton_menu.append($directbutton_download_button).append($directbutton_link_button);
            ...
            var $apibutton_a = $('<a class="g-button" href="javascript:void(0);"><span class="g-button-right"><span class="text" style="width:auto">其它外链</span></span></a>');
            var $apibutton_menu = $('<span class="menu" style="width:120px;left:77px"></span>');
            var $apibutton_download_button = $('<a id="download-api" class="g-button-menu" href="javascript:void(0);">点击直链下载</a>');
            var $apibutton_link_button = $('<a id="httplink-api" class="g-button-menu" href="javascript:void(0);">其它下载外链</a>');
            $apibutton_menu.append($apibutton_download_button).append($apibutton_link_button);
        ...
        function linkClick(event){
            ...
            if(id.indexOf('direct') != -1){
                ...
                tip = '提示：文件的直链下载链接不一定支持IDM/迅雷下载。注：多个文件及目录获取不到!';
                ...
                if(id.indexOf('api') != -1){
                    ...
                    tip = '显示模拟百度网盘网页获取的链接，可以使用下载工具下载，复制到下载工具需要传递cookie，多文件打包下载的链接可以直接复制';
        ...
        function batchClick(event){
            ...
            if(id.indexOf('direct') != -1){
                ...
                tip = '显示所有选中文件的直链下载链接，文件夹显示为打包下载的链接';
    ...
    function PanShareHelper(){
        ...
        function addButton(){
            ...
            var $dropdownbutton_a_span = $('<span class="g-button-right"><em class="icon icon-download" title="百度网盘直链下载插件"></em><span class="text" style="width: auto;">直链下载</span></span>');
            var $dropdownbutton_span = $('<span class="menu" style="width:auto;z-index:41"></span>');

            var $downloadButton = $('<a data-menu-id="b-menu207" class="g-button-menu" href="javascript:void(0);">点击直链下载</a>');
            var $linkButton = $('<a data-menu-id="b-menu208" class="g-button-menu" href="javascript:void(0);">获取下载链接</a>');
        ...
        function confirmClick(){
            ...
            if(result.errno == -20){
                ...
                if(buttonTarget == 'download'){
                    ...
                    var tip = "提示：获取的直链下载链接，不一定支持IDM/迅雷正常下载。注：多个文件及目录获取不到!";
                    dialog.open({title:'下载链接',type:'link',list:linkList,tip:tip});
                }
            } else {
                alert('发生错误！');
        ...
        function linkButtonClick(){
            ...
            if(downloadLink.errno == -20) {
                ...
                var tip = "提示：获取的直链下载链接，支持使用IDM/迅雷不限速下载。注：多个文件及目录获取不到下载链接!";
                dialog.open({title:'下载链接',type:'link',list:linkList,tip:tip});
            } else {
                alert('获取下载链接失败！');
                return;
